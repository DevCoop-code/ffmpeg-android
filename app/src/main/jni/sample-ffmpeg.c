//
// Created by HanGyo Jeong on 2021-01-17.
//
...
JNIEXPORT jint JNICALL Java_com_hankyo_jeong_avideoeditor_NDK_scanning(JNIEnv *env, jobject object, jstring filepath)
{
    ...
    LOGI("Start to find stream information");
    // 유효한 스트림 정보 찾기
